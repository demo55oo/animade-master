...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      fetch(" https://backednlatestanimade-production.up.railway.app/api/users/profile/", {
        method: "GET",
        headers: {
    ...
    <>
      <div className={styles.page}>
        ...
        <div className={styles.content}>
          <h3 className="section__title">Past Designs ({designs.length})</h3>
          <Cardo showImageAttribute={true} list={designs} />
        </div>
      </div>
      <FooterBtns>
        <div>
